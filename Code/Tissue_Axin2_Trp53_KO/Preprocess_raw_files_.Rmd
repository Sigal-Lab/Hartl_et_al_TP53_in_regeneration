---
title: "Microarray Data - Axin2 Trp53 KO - analysis with LIMMA"
...
exp_design = subset(exp_design, ID %in% 5:8)

#exp_design$dye_swap = rep(c(T,F), times=nrow(exp_design)/2)
KO_cy5 = with(exp_design, grepl("KO", Cy5_condition))
...
```{r}
ed=ed_orig
save(ed, RG, MA, file="../../Data/Processed/Axin2_Trp53_KO_preprocessed_data.Rdata")
```
